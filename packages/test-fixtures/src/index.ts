...
function createPrototypeSchedule(): ScheduleItem[] {
  const sessions: PrototypeSession[] = [
    ...
    },
    {
      ...
      summary: "A private founder dinner for conversation, connection, and the evening program.",
      locationId: locationIds.swSteakhouse,
    ...
    },
    {
      ...
      summary: "A practical workshop introducing DBT-informed tools for parents and families.",
      locationId: locationIds.nourishRoom,
      locationName: "Mouton 2 - Nourish Room",
      audience: "community",
      offsets: [15]
    ...
    },
    {
      ...
      summary: "A morning of main-stage conversations for the Community Day program.",
      locationId: locationIds.wisdomForum,
      locationName: "Margaux - Wisdom Forum",
      audience: "community",
      featured: true,
