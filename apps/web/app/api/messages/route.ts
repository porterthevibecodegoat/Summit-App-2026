...
export async function POST(request: Request) {
  ...
  if (!process.env.MESSAGE_DELIVERY_WEBHOOK_URL) {
  ...
  return NextResponse.json({ message: "Connection request sent by email and queued for in-app delivery when available." });
}
