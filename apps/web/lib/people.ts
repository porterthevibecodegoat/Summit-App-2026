...
export const people2026: SummitPerson[] = [
  ...
  make("David Eagleman", ["Experts"], "Neuroscientist & Inventor", 2026, { image: "https://static1.squarespace.com/static/628691b65c3a24383d0eac0a/t/690713aa32f0d432b696a34f/1762071467583/David+Eagleman.jpg?format=500w" }),
  ...
  ...["Lexi Hensler", "Margaret Hines", "Brandon Saho", "Caroline Silby", "Anthony Ramos", "Mario Martinez", "Alana Springsteen"].map((name) => make(name, ["Entertainers & Athletes"], "Speaker or performer — details pending approval")),
