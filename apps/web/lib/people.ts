...
const candidateProfiles2026: SummitPerson[] = [
  make("Jewel Murray", ["Co-Chairs", "Musicians"], "4-Time Grammy Nominated Singer-Songwriter and Mental Health Pioneer", 2026, { image: "https://static1.squarespace.com/static/628691b65c3a24383d0eac0a/t/68def5c21087564f13f1c2ec/1759442376820/Jewel+smiling.png?format=500w" }),
  make("Steve Wozniak", ["Co-Chairs", "Founders"], "Co-Founder of Apple & Mental Health Advocate", 2026, { image: "/people/steve-wozniak-drive.jpg" }),
  ...
  make("Ryan Wolfington", ["Founders", "Executive Producers"], "Founder, Inspiring Children Foundation", 2026, { order: 1, image: "/people/ryan-wolfington.jpg" }),
  make("Cameron Kelly", ["Founders"], "Philanthropist", 2026, { order: 2, image: "https://static1.squarespace.com/static/628691b65c3a24383d0eac0a/t/68e609ca36e8ea273aba67ca/1759906250781/Winston+and+Cameron+sq.jpg?format=500w" }),
  make("Winston Kelly", ["Founders"], "Philanthropist", 2026, { order: 3, image: "https://static1.squarespace.com/static/628691b65c3a24383d0eac0a/t/68e609ca36e8ea273aba67ca/1759906250781/Winston+and+Cameron+sq.jpg?format=500w" }),
  make("Janet Wozniak", ["Founders"], "Apple Computers", 2026, { order: 4, image: "https://static1.squarespace.com/static/628691b65c3a24383d0eac0a/t/68ec81e77594567546cc159d/1760330215338/Steve+and+Janet+Wozniak+sq.jpg?format=500w" }),
  make("Sean Wolfington", ["Founders"], "Entrepreneur", 2026, { order: 5, image: "https://static1.squarespace.com/static/628691b65c3a24383d0eac0a/t/68ec81cca6ad7d1cf09d23d5/1760330189118/Sean+and+Ana+Wolfington+sq.jpg?format=500w" }),
  make("Ana Wolfington", ["Founders"], "Entrepreneur", 2026, { order: 6, image: "https://static1.squarespace.com/static/628691b65c3a24383d0eac0a/t/68ec81cca6ad7d1cf09d23d5/1760330189118/Sean+and+Ana+Wolfington+sq.jpg?format=500w" }),
  make("Melinda Springer", ["Founders"], "Pickle Pro Labs", 2026, { order: 7, image: "/people/melinda-noah-springer.png" }),
  make("Noah Springer", ["Founders"], "Pickle Pro Labs", 2026, { order: 8, image: "/people/melinda-noah-springer.png" }),
  make("Jen Smorgen", ["Founders"], "Smorgon Family Foundation", 2026, { order: 9, image: "/people/jennifer-smorgon.png" }),
  make("Sanem (Sam) Alkan", ["Founders"], "Resonance Philanthropies", 2026, { order: 10, image: "/people/resonance-philanthropies.png" }),
  make("Adam Lewis", ["Founders"], "Summit founder"),
  make("Cathy Olson", ["Attendees"], "Press"),
  ...
  make("Daniel Gillison", ["Experts"], "NAMI", 2026, { image: "/people/daniel-gillison.png" }),
  make("Marc Brackett", ["Experts"], "Psychologist, Yale", 2026, { image: "/people/marc-brackett.jpg" }),
  ...
  make("Kevin Hines", ["Experts"], "Suicide Prevention Speaker", 2026, { image: "/people/kevin-hines.jpg" }),
  ...
  make("Blaise Aguirre", ["Experts"], "McLean Psychiatric Hospital", 2026, { image: "/people/blaise-aguirre.jpg" }),
  make("Loni Love", ["Hosts", "Entertainers & Athletes"], "Comedian and Not Alone Awards Host", 2026, { image: "/people/loni-love.jpg" }),
  ...
  make("Sarah Steil", ["Musicians"], "Musician", 2026, { image: "/people/sarah-steil.png" }),
  ...
  make("Lexi Hensler", ["Entertainers & Athletes"], "Social media influencer and Entrepreneur", 2026, { image: "/people/lexi-hensler.png" }),
  make("Brandon Saho", ["Entertainers & Athletes"], "Sports reporter and mental health advocate", 2026, { image: "/people/brandon-saho.png" }),
  make("Dr. Caroline Silby", ["Entertainers & Athletes"], "Sports psychologist and author", 2026, { image: "/people/caroline-silby.png" }),
  make("Anthony Ramos", ["Musicians"], "Musician and actor", 2026, { image: "/people/anthony-ramos.png" }),
...
export const people2025: SummitPerson[] = [
  make("Loni Love", ["Hosts", "Entertainers & Athletes"], "Comedian and Not Alone Awards Host", 2025, { image: "/people/loni-love.jpg" }),
  make("BLÜ EYES", ["Musicians"], "Singer-Songwriter", 2025, { image: "/people/blu-eyes.jpg" }),
  make("Cassadee Pope", ["Musicians"], "Singer-Songwriter", 2025, { image: "/people/cassadee-pope.jpg" }),
  make("Jon Foreman", ["Musicians"], "Switchfoot", 2025, { image: "/people/jon-foreman.jpg" }),
  make("Sheila E.", ["Musicians"], "Singer-Songwriter", 2025, { image: "/people/sheila-e.jpg" }),
  make("Tallulah Willis", ["Entertainers & Athletes"], "Actress & Advocate", 2025, { image: "/people/tallulah-willis.jpg" }),
