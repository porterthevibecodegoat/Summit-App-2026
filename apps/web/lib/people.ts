...
const candidateProfiles2026: SummitPerson[] = [
  ...
  make("Steve Wozniak", ["Co-Chairs"], "Co-Founder of Apple & Mental Health Advocate", 2026, { image: "/people/steve-wozniak-drive.jpg" }),
  ...
  make("Melinda & Noah Springer", ["Founders"], "Pickle Pro Labs", 2026, { order: 5, image: "/people/melinda-noah-springer.png" }),
  make("Jennifer Smorgon", ["Founders"], "Smorgon Family Foundation", 2026, { order: 6, image: "/people/jennifer-smorgon.png" }),
  make("Erica & Jay McGraw", ["Founders"], "Philanthropists and Mental Health Advocates", 2026, { order: 7, image: "/people/erica-jay-mcgraw.png" }),
  make("Sanem “Sam” Alkan", ["Founders"], "Resonance Philanthropies", 2026, { order: 8, image: "/people/resonance-philanthropies.png" }),
